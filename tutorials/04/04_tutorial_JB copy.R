...
# Step 1: Assumptions - catagorical (drama, comedy, etc)
# Step 2: Hypotheses - Ho that genre and rating are related
# Step 3: Test statistic
# Step 4: P-value
# Step 5: Conclusion - We can reject the null hypothesis which means that we can support the alternate are not independant
# movie genre and rating are not independant 
